...
export default function ContractDetailPage() {
  ...
  useEffect(() => {
    try {
      ...
      setContract(c);
      // Dùng dịch vụ step3 để tạo dữ liệu hiển thị nội dung
      // Ở đây không có inspectionId từ contract, nên tạo dữ liệu tối thiểu để render
      if (c) {
        // Tái sử dụng generator bằng cách map dữ liệu cơ bản tối thiểu
        (async () => {
          ...
          if (c.status === "Completed") {
            ...
            // staffSignature giữ undefined cho tới khi ký
          }
      ...
      <SidebarInset>
        <PageHeader
          crumbs={[
            ...
            { label: "Hợp đồng", href: "/staff/contract" },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              {contract?.status === "Completed" && (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    win.document.close();
                    // Đợi render xong rồi gọi print để người dùng lưu PDF
                    setTimeout(() => {
                      try {
                        win.focus();
                        win.print();
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/staff/contract">Quay lại</Link>
              </Button>
            </div>
          </div>
